...
public class ListActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        leftAdapter.setOnItemClickListener(new BaseSmartAdapter.OnRecyclerViewItemClickListener() {
            @Override
            public void onItemClick(View view, int i) {
                Intent intent = new Intent(ListActivity.this, VerGridActivity.class);
